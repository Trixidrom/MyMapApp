...
class RasterOverlayFragment : Fragment(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Mapbox.getInstance(requireContext(), null, WellKnownTileServer.Mapbox)
    ...
    override fun onMapReady(mapboxMap: MapboxMap) {
        ...
        val mapTilerKey = Helper.getMapTilerKey(requireContext())
    ...
    private fun addRasterLayer(style: Style) {
        ...
        val inputStream: InputStream = requireContext().assets.open("aerial_wgs84.png")
